...
def _hit11():#公司基本資料
    ...
    itemS=wwW.find_elements(By.XPATH,"/html/body/table[2]/tbody/tr/td[3]/table/tbody/tr[1]/td/table/tbody/tr/td[1]/table/tbody")

    for item in itemS:
        listBox.insert(tk.END,item.find_element(By.CLASS_NAME,"link_blue").text)
